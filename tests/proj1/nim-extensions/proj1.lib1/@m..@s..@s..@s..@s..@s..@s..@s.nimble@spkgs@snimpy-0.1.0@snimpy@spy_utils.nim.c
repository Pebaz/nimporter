...
N_LIB_PRIVATE N_NIMCALL(void, conversionToStringError__2YA4NXAzmPMdXt3hDLwaKQ)(void) {	Exception* eX60gensym366150_;
	...
	(*eX60gensym366150_).message = copyString(((NimStringDesc*) &TM__yNJ2G9b01RlVILlUjgj0ESA_2));
	(*eX60gensym366150_).parent = NIM_NIL;
...
{	result = (NIM_BOOL)0;
	...
	LA1_: ;
	(*output) = mnewString(((NI)chckRange(l, ((NI) 0), ((NI) IL64(9223372036854775807)))));
	{
