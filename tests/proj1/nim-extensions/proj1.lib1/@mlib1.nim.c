...
static N_NIMCALL(void, TM__K2VBz5lNBsOlJxCMZa0M5A_2)(void);
...
N_LIB_PRIVATE N_CDECL(void*, func1Py_wrapper__xvYxTivdledMq9bdMUOp9c4Q)(void* selfX60gensym386238_, void* args, void* kwargs);
static N_INLINE(void, updateStackBottom__FRn3WNsRdbdvfuL6O7x1BQnimpy)(void);
N_NOINLINE(void, nimGC_setStackBottom)(void* theStackBottom);
N_LIB_PRIVATE N_NIMCALL(void*, noinline__CKu6pG3o0dxlMOrCpE86sg)(void* args, void* kwargs);
...
N_LIB_PRIVATE N_NIMCALL(NI, func1__ReJSBp6QvwVPOQpSwoy4hg)(void);
...
tyObject_PyModuleDesc__gBC8z6Ez5xj3dXoP0ylCRA gPythonLocalModuleDesc__Qb6aCqn2eOy60xfjmAq7Ow;
...
STRING_LITERAL(TM__K2VBz5lNBsOlJxCMZa0M5A_3, "lib1", 4);
STRING_LITERAL(TM__K2VBz5lNBsOlJxCMZa0M5A_4, "func1", 5);
static N_NIMCALL(void, TM__K2VBz5lNBsOlJxCMZa0M5A_2)(void) {
	nimGCvisit((void*)gPythonLocalModuleDesc__Qb6aCqn2eOy60xfjmAq7Ow.methods, 0);
	nimGCvisit((void*)gPythonLocalModuleDesc__Qb6aCqn2eOy60xfjmAq7Ow.types, 0);
	nimGCvisit((void*)gPythonLocalModuleDesc__Qb6aCqn2eOy60xfjmAq7Ow.iterators, 0);
}
N_LIB_EXPORT N_CDECL(void, initlib1)(void) {	initModule2__QOPr6RYgxP9c8n2lZVbiDwA((&gPythonLocalModuleDesc__Qb6aCqn2eOy60xfjmAq7Ow));
}
N_LIB_EXPORT N_CDECL(void*, PyInit_lib1)(void) {	void* result;
	result = (void*)0;
	result = initModule3__b5gVEAN0cbSksVFIpPmViA((&gPythonLocalModuleDesc__Qb6aCqn2eOy60xfjmAq7Ow));
	return result;
}
...
N_LIB_PRIVATE N_NIMCALL(NI, func1__ReJSBp6QvwVPOQpSwoy4hg)(void) {	NI result;
{	result = (NI)0;
	result = ((NI) 1);
	goto BeforeRet_;
	}BeforeRet_: ;
...
N_LIB_PRIVATE N_NIMCALL(void*, noinline__CKu6pG3o0dxlMOrCpE86sg)(void* args, void* kwargs) {	void* result;
	TSafePoint TM__K2VBz5lNBsOlJxCMZa0M5A_5;
{	result = (void*)0;
	{
		tyArray__z9ac6Ez5VSEHe9bC2NMwuc7Q T3_;
		NIM_BOOL T4_;
		T4_ = (NIM_BOOL)0;
		T4_ = verifyArgs__8sVYJT4zfbIXMNXtJ2cTng(args, kwargs, ((NI) 0), ((NI) 0), T3_, 0, ((NimStringDesc*) &TM__K2VBz5lNBsOlJxCMZa0M5A_4));
		if (!!(T4_)) goto LA5_;
		result = ((void*) (NIM_NIL));
		goto BeforeRet_;
	}
	LA5_: ;
	pushSafePoint(&TM__K2VBz5lNBsOlJxCMZa0M5A_5);
	TM__K2VBz5lNBsOlJxCMZa0M5A_5.status = _setjmp(TM__K2VBz5lNBsOlJxCMZa0M5A_5.context);
	if (TM__K2VBz5lNBsOlJxCMZa0M5A_5.status == 0) {
		NI T8_;
		T8_ = (NI)0;
		T8_ = func1__ReJSBp6QvwVPOQpSwoy4hg();
		...
		if (isObj(getCurrentException()->Sup.m_type, (&NTI__XEycrCsme5C8CVWAYEcdBQ_))) {
			...
			TM__K2VBz5lNBsOlJxCMZa0M5A_5.status = 0;
			eX60gensym386239_ = getCurrentException();
			result = pythonException__Zl8uxcjgHaQZB15tcqXlTA(eX60gensym386239_);
			popCurrentException();
		}
	}
	if (TM__K2VBz5lNBsOlJxCMZa0M5A_5.status != 0) reraiseException();
	}BeforeRet_: ;
	return result;
}
N_LIB_PRIVATE N_CDECL(void*, func1Py_wrapper__xvYxTivdledMq9bdMUOp9c4Q)(void* selfX60gensym386238_, void* args, void* kwargs) {	void* result;
	tyProc__iv6n7tcGawU401muvntJ9cA volatile pX60gensym386240_;
	result = (void*)0;
	updateStackBottom__FRn3WNsRdbdvfuL6O7x1BQnimpy();
	pX60gensym386240_ = noinline__CKu6pG3o0dxlMOrCpE86sg;
...
N_LIB_PRIVATE N_NIMCALL(void, NimMainModule)(void) {
{
	...
	nimRegisterGlobalMarker(TM__K2VBz5lNBsOlJxCMZa0M5A_2);

	initPythonModuleDesc__0f1AKGy9a6FMRjtYbL5nSQg((&gPythonLocalModuleDesc__Qb6aCqn2eOy60xfjmAq7Ow), "lib1", "");
	registerExportedModule__2aw5dpL5lVZZ9cjH0apWcXA(((NimStringDesc*) &TM__K2VBz5lNBsOlJxCMZa0M5A_3), ((void*) (initlib1)), ((void*) (PyInit_lib1)));
	addMethod__TpUnmhxGlZgxTBTLPiE3nw((&gPythonLocalModuleDesc__Qb6aCqn2eOy60xfjmAq7Ow), "func1", NIM_NIL, func1Py_wrapper__xvYxTivdledMq9bdMUOp9c4Q);
}
}
