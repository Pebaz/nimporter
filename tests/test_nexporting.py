...
from . import temporarily_install_nimporter


def test_sdist_all_targets_builds_correctly(temporarily_install_nimporter):
...
def test_sdist_all_targets_installs_correctly(temporarily_install_nimporter):
    "Assert all items are correctly imported"
    try:
        code, stdout, stderr = run_process(
...
def test_setup_py_all_targets_installs_correctly(temporarily_install_nimporter):
