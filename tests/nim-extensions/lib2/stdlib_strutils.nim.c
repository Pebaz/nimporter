...
N_LIB_PRIVATE N_NOINLINE(void, invalidFormatString__8vOMwvNB8blLQSoRXfInAg)(void) {	tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw* eX60gensym246570_;
	NimStringDesc* T1_;
	eX60gensym246570_ = (tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw*)0;
	eX60gensym246570_ = (tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw*) newObj((&NTI__Ie1m0dv1ZHg72IgPRr1cDw_), sizeof(tyObject_ValueError__yoNlBGx0D2tRizIdhQuENw));
	(*eX60gensym246570_).Sup.Sup.Sup.m_type = (&NTI__yoNlBGx0D2tRizIdhQuENw_);
	(*eX60gensym246570_).Sup.Sup.name = "ValueError";
	T1_ = (NimStringDesc*)0;
	T1_ = (*eX60gensym246570_).Sup.Sup.message; (*eX60gensym246570_).Sup.Sup.message = copyStringRC1(((NimStringDesc*) &TM__JGc9b9bh2D3nTdUR7TGyq8aA_5));
	if (T1_) nimGCunrefNoCycle(T1_);
	asgnRef((void**) (&(*eX60gensym246570_).Sup.Sup.parent), NIM_NIL);
	raiseExceptionEx((Exception*)eX60gensym246570_, "ValueError", "invalidFormatString", "strutils.nim", 2634);
}
